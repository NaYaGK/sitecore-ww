**Variables**
    - `{COMPONENT_SPEC_PATH}` — `ai/prompts/component_specs/industry_sector_teaser.md`
    - `{COMPONENT_NAME}` — `IndustrySectorTeaser`
  ...
  **1. Understand the spec and reference UI**
  ...
  - Read the component requirements at `ai/prompts/component_specs/industry_sector_teaser.md`.
  ...
  **2. Plan the files and structure**
  ...
  The component must live under `src/components/IndustrySectorTeaser`. Within that folder include:

  - `IndustrySectorTeaser.tsx` — main component (strictly typed props, exported).
  - `IndustrySectorTeaser.module.scss` — all styling here; use Sass features (variables, nesting, mixins) as needed.
  - `IndustrySectorTeaser.props.ts` — Sitecore field/interface definitions if needed.
  - `IndustrySectorTeaser.stories.tsx` — Storybook story with realistic mock data.
  ...
  **3. Implementation specifics**
  ...
  - Mirror the reference design exactly in `IndustrySectorTeaser.module.scss`: fonts, sizes, weights, spacing, border radii, shadows, responsive layout, motion.
  ...
  **4. Storybook-first deliverable**
  ...
  - `IndustrySectorTeaser.stories.tsx` must render the component using realistic mock data derived from the spec.
