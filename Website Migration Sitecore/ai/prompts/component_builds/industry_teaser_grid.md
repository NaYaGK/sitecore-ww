**Variables**
    - `{COMPONENT_SPEC_PATH}` — `ai/prompts/component_specs/industry_teaser_grid.md`
    - `{COMPONENT_NAME}` — `IndustryTeaserGrid`
  ...
  **1. Understand the spec and reference UI**
  ...
  - Read the component requirements at `ai/prompts/component_specs/industry_teaser_grid.md`.
  ...
  **2. Plan the files and structure**
  ...
  The component must live under `src/components/IndustryTeaserGrid`. Within that folder include:

  - `IndustryTeaserGrid.tsx` — main component (strictly typed props, exported).
  - `IndustryTeaserGrid.module.scss` — all styling here; use Sass features (variables, nesting, mixins) as needed.
  - `IndustryTeaserGrid.props.ts` — Sitecore field/interface definitions if needed.
  - `IndustryTeaserGrid.stories.tsx` — Storybook story with realistic mock data.
  ...
  **3. Implementation specifics**
  ...
  - Mirror the reference design exactly in `IndustryTeaserGrid.module.scss`: fonts, sizes, weights, spacing, border radii, shadows, responsive layout, motion.
  ...
  **4. Storybook-first deliverable**
  ...
  - `IndustryTeaserGrid.stories.tsx` must render the component using realistic mock data derived from the spec.
